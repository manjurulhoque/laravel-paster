            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('paste.update', $paste) }}">
                            @csrf
                            <div class="form-group">
                                <label for="content" class="font-weight-bold">Edit Paste</label>
                                <textarea name="contents" class="form-control" rows="15"
                                          id="content"
                                          autofocus>{{ old('content', $paste->content) }}</textarea>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @php
                                            $selected = old('syntax', $paste->syntax);
                                        @endphp
                                    ...
                                    <div class="form-group">
                                        ...
                                        @php
                                            $selected = old('expire', $paste->expire);
                                        @endphp
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @php
                                            $selected = old('status', $paste->status);
                                        @endphp
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control"
                                               placeholder="Paste Title" value="{{old('title', $paste->title)}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" @if($paste->encrypt) checked
                                                   @endif class="custom-control-input" id="defaultUnchecked"
                                                   name="encrypt">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-success">Update Paste</button>
                                    </div>
                                </div>
                            </div>
                        </form>
